                        ...
                        try {
                            ...
                            if (aiReply) {
                                ...
                                if (!emailAccount) {
                                    ...
                                    // FIX: token refresh has its own try-catch
                                    // If it fails, we log and skip sending — webhook still returns 200
                                    ...
                                    if (accessToken) {
                                        const result = await sendEmail(
                                            ...
                                            `Re: ${messageData.subject}`, aiReply
                                        );
                                        if (result.success) {
                                            lead.replies.push({
                                                date: new Date(), content: aiReply,
